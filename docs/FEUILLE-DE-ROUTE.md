...
| E1 | `e1-api-plugins` | `prisme_core.api`, hooks synchrones, gestionnaire de plugins, migration des plugins, secrets chiffrés, fiches de décision | En revue |
| E2 | `e2-index-sqlite` | Index SQLite FTS5 dans le profil, double granularité fichier + segment | À faire |
| E3 | `e3-provenance` | Frontmatter `prisme_*`, identifiants posés au besoin, horloge d'enregistrement | À faire |
